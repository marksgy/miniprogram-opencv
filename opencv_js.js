...
function createWasm() {
  ...
  function instantiateArrayBuffer(receiver) {
    return WXWebAssembly.instantiate("/pages/index/opencv.wasm", info)
...
function craftInvokerFunction(
  ...
  var anonymous = function (
    ...
    return (Module[makeLegalFunctionName(humanName)] = function (
      arg0,
      arg1,
      arg2,
      arg3,
      ...
      for (var i = 6; i < parentargs.length; ++i) {
        if (
          parentargs[i] !== null &&
          parentargs[i].destructorFunction === undefined
        ) {
      ...
      for (var i = 6, k = argWired.length; i < parentargs.length; i++) {
        if (parentargs[i] == null || typeof parentargs[i] != "object") {
        } else {
          if (needsDestructorStack) {
...
function __emval_get_method_caller(argCount, argTypes) {
  ...
  var anonymous = function (
    ...
    var parentargs = Array.from(arguments);
    return (Module[makeLegalFunctionName("methodCaller_" + signatureName)] =
      function (handle, name, destructors, args) {
        var args = Array.from(arguments);
        var argsList = [];
        for (var i = 0; i < argCount - 1; ++i) {
          argsList.push("arg" + i);
...
var dynCall_ji = (Module["dynCall_ji"] = function () {
  return (dynCall_ji = Module["dynCall_ji"] = Module["asm"]["ga"]).apply(
    null,
    arguments
  );
});
